...
class PDF_LibroController extends Controller
{
    ...
    public function pdf_libro()
    {
      ...
      // tramites----------------------
      return $tramites=Tramite::select('tramite.idTramite','tramite.idUsuario','tramite.idDependencia_detalle', DB::raw('CONCAT(usuario.nombres," ",usuario.apellidos) as nombreComp')
