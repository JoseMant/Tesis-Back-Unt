...
use App\Mail\EnvioCertificadoMail;
class EnvioCertificadoJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        ->send(new \App\Mail\EnvioCertificadoMail($this->usuario,$this->tramite,$this->tipo_tramite,$this->tipo_tramite_unidad,$this->ruta));
    }
}
