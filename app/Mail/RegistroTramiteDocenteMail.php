...
class RegistroTramiteDocenteMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return  $this->from($emisor, 'UNIDAD DE REGISTRO ACADÉMICO ADMINISTRATIVO')->subject($subject)->view('emails.docente_registroSolicitud');
