...
class PadronSuneduExport implements FromCollection,WithHeadings,ShouldAutoSize, WithEvents,WithColumnFormatting
{
    public $idOficio;
    /**
    ...
    */
    ...
    public function headings(): array
    {
        return [
            ...
            ,'PROC_GRADO_EXT','REG_OFICIO','FEC_MAT_MOD', //FEC_MAT_PROG
    ...
    public function collection()
    {
        ...
        DB::raw('date_format(tramite_detalle.fecha_primera_matricula, "%d/%m/%Y") as MATRI_FEC'),
        DB::raw('date_format(tramite_detalle.fecha_ultima_matricula, "%d/%m/%Y") as EGRES_FEC'),
        ...
        DB::raw("(case 
                    when tramite.idUnidad = 4 then  (select nombre from mencion where idMencion=tramite.idDependencia_detalle)
                end) AS SEG_ESP"),
        DB::raw("(case 
                when tipo_tramite_unidad.idTipo_tramite_unidad = 15 then '004'
        ...
        DB::raw('date_format(tramite_detalle.fecha_inicio_acto_academico, "%d/%m/%Y") as FEC_INI_TRA_TIT'),
        ...
        DB::raw('date_format(resolucion.fecha, "%d/%m/%Y") as RESO_FEC'),
        // 'resolucion.fecha AS RESO_FEC',
        DB::raw('CONCAT("") as RESO_NUM_DUP_NUE'),
        DB::raw('CONCAT("") as RESO_FEC_DUP_NUE'),
        DB::raw('date_format(cronograma_carpeta.fecha_colacion, "%d/%m/%Y") as DIPL_FEC_ORG'),
