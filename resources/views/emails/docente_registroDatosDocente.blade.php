    ...
    <div class="contenido">
        <div class="alert alert-info mensaje" role="alert">
						...
						<div style="text-align: justify!important;">
							<p>Se han registrado los datos de un nuevo docente en el trámite de {{$tipo_tramite['descripcion']}} - {{$tipo_tramite_unidad['descripcion']}} realizado virtualmente para su validación. 
