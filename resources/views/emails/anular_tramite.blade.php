    ...
    <div class="contenido">
        <div class="alert alert-info mensaje" role="alert">
						...
						<div style="text-align: justify!important;">
                            <p>Estimado {{$usuario['nombres']}} {{$usuario['apellidos']}}, se le comunica que se ha realizado la anulación del trámite de {{$tipo_tramite['descripcion']}} - {{$tipo_tramite_unidad['descripcion']}} realizado en la mesa de partes 
                                virtual , debido al siguiente motivo: 
                            </p>
                            {!!$notificacion!!}
