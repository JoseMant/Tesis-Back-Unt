    ...
    <div class="contenido">
        <div class="alert alert-info mensaje" role="alert">
						<div style="text-align: center;">
							<h4>NOTIFICACIÓN DEL TRÁMITE {{$tipo_tramite['descripcion']}} - {{$tipo_tramite_unidad['descripcion']}}</h4>
							<img class="robot" src="https://i.ibb.co/5RsJVpc/robot-Confirmation.png" width="50%">
						</div>
						<hr>
						<div style="text-align: justify!important;">
                            <p>Estimados, se les comunica que se ha presentado una demora en el trámite de {{$tipo_tramite['descripcion']}} - {{$tipo_tramite_unidad['descripcion']}} realizado en la mesa de partes 
                                virtual por {{$usuario['nombres']}} {{$usuario['apellidos']}}, debido al siguiente motivo: 
                            </p>
                            {!!$notificacion!!}
							<p>Favor coordinar con los involucrados para la agilización de dicho trámite.</b>
                            </p>
                            <!-- <p>Tu código de trámite es: N° {{$tramite['nro_tramite']}}. Recuerda ingresar al sistema para revisar el estado de tus trámites.
                            </p> -->
						</div>
            <hr>
