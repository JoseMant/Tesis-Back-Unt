    ...
    <div class="contenido">
        <div class="alert alert-info mensaje" role="alert">
						<div style="text-align: center;">
							<h4>NOTIFICACIÓN DE TRÁMITE PENDIENTE DE FIRMA DE DECANO</h4>
							<img class="robot" src="https://i.ibb.co/5RsJVpc/robot-Confirmation.png" width="50%">
						</div>
						<hr>
						<div style="text-align: justify!important;">
							<p>Hola {{$decano['nombres']}} {{$decano['apellidos']}}, el trámite N° {{$tramite['nro_tramite']}} de {{$tipo_tramite['descripcion']}} - {{$tipo_tramite_unidad['descripcion']}} realizado en la mesa de partes 
                                virtual se encuentra pendiente de firma de decano. Recuerda ingresar al sistema para revisar los trámites pendientes.
                            </p>
						</div>
            <hr>
