    ...
    <div class="contenido">
        <div class="alert alert-info mensaje" role="alert">
						...
						<div style="text-align: justify!important;">
							<p>Se ha registrado con éxito el trámite de {{$tipo_tramite['descripcion']}} - {{$tipo_tramite_unidad['descripcion']}} realizado virtualmente. 
                                El código de trámite es: N° {{$tramite['nro_tramite']}}. 
                            </p>
						</div>
            <hr>
