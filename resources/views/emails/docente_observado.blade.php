    ...
    <div class="contenido">
        <div class="alert alert-info mensaje" role="alert">
						...
						<div style="text-align: justify!important;">
							<p>Hola {{$usuario['nombres']}} {{$usuario['apellidos']}}, tu trámite de {{$tipo_tramite['descripcion']}} - {{$tipo_tramite_unidad['descripcion']}} realizado 
                                virtualmente ha sido observado. Tu código de trámite es: N° {{$tramite['nro_tramite']}}.
                            </p>
						</div>
            <hr>
