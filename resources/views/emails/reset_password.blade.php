    ...
    <div class="contenido">
        <div class="alert alert-info mensaje" role="alert">
						<div style="text-align: center;">
							<h4>NOTIFICACIÓN DE RECUPERACIÓN DE CONTRASEÑA</h4>
							<img class="robot" src="https://i.ibb.co/5RsJVpc/robot-Confirmation.png" width="50%">
						</div>
						<hr>
						<div style="text-align: justify!important;">
							<p>Hola {{$usuario['nombres']}} {{$usuario['apellidos']}}, por favor haga click en el siguiente enlace  para continuar con la recuperación de su contraseña.
                            </p>
						</div>
            <hr>
