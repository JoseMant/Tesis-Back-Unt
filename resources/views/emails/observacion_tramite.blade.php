    ...
    <div class="contenido">
        <div class="alert alert-info mensaje" role="alert">
						...
						<div style="text-align: justify!important;">
							<p>Hola {{$usuario['nombres']}} {{$usuario['apellidos']}}, tu trámite de {{$tipo_tramite['descripcion']}} - {{$tipo_tramite_unidad['descripcion']}} realizado en la mesa de partes 
                                virtual ha sido observado. Tu código de trámite es: N° {{$tramite['nro_tramite']}}. Recuerda ingresar al sistema para revisar el estado de tus trámites.
                            </p>
						</div>
            <hr>
